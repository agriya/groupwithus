	...
	<div class="clearfix">
        ...
        <ul class="filter-list-block clearfix">
            ...
            <li class="verified <?php echo $class; ?>" title="<?php echo __l('Under Process'); ?>"><?php echo $this->Html->link( $this->Html->cInt($approved ,false) . '<span>' . __l('Under Process').'</span>', array('controller' => 'charity_cash_withdrawals', 'action' => 'index', 'filter_id' => ConstCharityCashWithdrawalStatus::Approved), array('escape' => false));?></li>
    		...
    		<li class="green <?php echo $class; ?>" title="<?php echo __l('Success');?>"><?php echo $this->Html->link( $this->Html->cInt($success ,false) . '<span>' . __l('Success').'</span>', array('controller' => 'charity_cash_withdrawals', 'action' => 'index', 'filter_id' => ConstCharityCashWithdrawalStatus::Success), array('escape' => false));?></li>
    		...
    		<li class="suspended <?php echo $class; ?>" title="<?php echo __l('Failed'); ?>"><?php echo $this->Html->link( $this->Html->cInt($failed ,false) . '<span>' . __l('Failed').'</span>', array('controller' => 'charity_cash_withdrawals', 'action' => 'index', 'filter_id' => ConstCharityCashWithdrawalStatus::Failed), array('escape' => false));?></li>

            <?php $class = (empty($this->request->data['Property']['filter_id'])) ? ' active-filter' : null; ?>
    		<li class="black <?php echo $class; ?> " title="<?php echo __l('All');?>"><?php echo $this->Html->link( $this->Html->cInt($approved  + $success + $failed ,false) . '<span>' . __l('All').'</span>', array('controller' => 'charity_cash_withdrawals', 'action' => 'index', 'filter_id' => 'all'), array('escape' => false)); ?></li>
        </ul>
