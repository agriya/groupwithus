...
<div class="info-details">
	<p>
		<?php echo __l('Using charity feature, site can support charities on every purchase. Charities are to be added and managed by site admin. All contributions for charities will be accumulated in their wallet. Once lumpsum amount is accumulated in wallet, site admin may directly pay/clear to charity if "Transfer Account" is configured. When site admin processes the payment manually through offline mode, he may also mark it as paid/cleared.');?>
	</p>
</div>
...
<div class="overflow-block">
    <table class="list">
        <tr>
            ...
            <th rowspan="2" class="dl"><div class="js-pagination"><?php echo $this->Paginator->sort(__l('Charity'),'name');?></div></th>
            <th rowspan="2" class="dl"><?php echo __l('Transfer Account');?></th>
            <th colspan="2"><?php echo __l('Share');?></th>
            <th colspan="3"><?php echo __l('Amount');?></th>
        </tr>
      	<tr> 
            <th class="dr"><div class="js-pagination"><?php echo $this->Paginator->sort(__l('Merchant'),'total_seller_amount');?></div></th>		
            <th class="dr"><div class="js-pagination"><?php echo $this->Paginator->sort(__l('Site'),'total_site_amount');?></div></th>
            <th class="dr"><div class="js-pagination"><?php echo $this->Paginator->sort(__l('Total'),'total_amount');?><div><?php echo '('.__l('Merchant').' + '.__l('Site').')'; ?></div></div></th>
            <th class="dr"><div class="js-pagination"><?php echo $this->Paginator->sort(__l('Paid').'/'.__l('Cleared'),'paid_amount');?></div></th>		
            <th class="dr"><div class="js-pagination"><?php echo $this->Paginator->sort(__l('Wallet'),'available_amount');?></div></th>
    	</tr>
<?php
if (!empty($charities)):
...
?>
	<tr class="<?php echo $class;?><?php echo $active_class; ?>">
       ...
       <span><?php echo $this->Html->cText($charity['CharityCategory']['name']);?></span>
		...
		?></td>
		<td class="dr"><?php echo $this->Html->siteCurrencyFormat($charity['Charity']['total_seller_amount']); ?></td>
		<td class="dr"><?php echo $this->Html->siteCurrencyFormat($charity['Charity']['total_site_amount']); ?></td>
		<td class="dr"><?php echo $this->Html->siteCurrencyFormat($charity['Charity']['total_amount']); ?></td>
		<td class="paid-amount dr"><?php echo $this->Html->siteCurrencyFormat($charity['Charity']['paid_amount']); ?></td>
		<td class="site-amount dr"><?php echo $this->Html->siteCurrencyFormat($charity['Charity']['available_amount']); ?></td>
	</tr>
<?php
    endforeach;
else:
