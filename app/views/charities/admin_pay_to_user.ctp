...
?>
	<tr<?php echo $class;?>>
       ...
       <?php echo $this->Html->cText($charity['Charity']['name']);?>
		...
		<td class="dr"><?php echo $this->Html->siteCurrencyFormat($charity['Charity']['available_amount']); ?></td>
		<td class="dl"><?php
		...
		<td class="dr"><?php echo $this->Html->siteCurrencyFormat($charity['Charity']['paid_amount']); ?></td>
	</tr>
<?php
    endforeach;
else:
