	...
	<div class="main-left-shadow">
		<div class="main-right-shadow">
			<div class="main-inner clearfix">
                ...
                <span class="ribbon-inner"><?php echo __l('Overview'); ?>
                </span>
                </span>
                <span class="js-chart-showhide up-arrow {'chart_block':'merchant-dashboard-overview'}">&nbsp;</span></h2>
				<div class="admin-center-block clearfix dashboard-center-block" id="merchant-dashboard-overview">
					<div class="clearfix">
						<?php echo $this->Form->create('Chart' , array('class' => 'language-form', 'action' => 'chart_merchant_transactions')); ?>
						...
						<div class="dashboard-cl">
							<div class="dashboard-cr">
								<div class="dashboard-cc clearfix">
									<div id="transactions_line_chart" class="merchant-dashboard-chart"></div>
									<div class="hide">
					...
					<div class="js-load-column-chart chart-half-section {'data_container':'total_orders_column_data', 'chart_container':'total_orders_column_chart', 'chart_title':'<?php echo __l('Total Orders') ;?>', 'chart_y_title': '<?php echo __l('Orders');?>'}">
						...
						<div class="dashboard-cl">
							<div class="dashboard-cr">
								<div class="dashboard-cc clearfix">
									<div id="total_orders_column_chart" class="merchant-dashboard-chart"></div>
									<div class="hide">
