<div class="clearfix js-responses js-load-admin-chart-users-login-ctp">
	<?php
		...
		if($user_type_id == ConstUserTypes::Merchant){
			$chart_title = __l('Merchant Login');
			$chart_y_title = __l('Companies');
		...
		<div class="main-right-shadow">
			<div class="main-inner clearfix">
				<h2 class="chart-dashboard-title ribbon-title clearfix">
                    <span class="ribbon-right"><span class="ribbon-inner"><?php echo __l('Login').' - '.$page_title; ?></span></span>
				...
				<div class="admin-center-block clearfix dashboard-center-block <?php echo (empty($this->request->params['isAjax']))? 'hide' : ''; ?>" id="admin-dashboard-user-login<?php echo $user_type_id; ?>">
					<div class="clearfix">
						<?php echo $this->Form->create('Chart' , array('class' => 'language-form', 'action' => 'chart_user_logins')); ?>
						<?php 
