<?php /* SVN: $Id: admin_index.ctp 71560 2011-11-15 17:46:52Z arovindhan_144at11 $ */ ?>
	<?php 
	...
	<?php if(empty($this->request->data)): ?>
        ...
        <ul class="filter-list-block clearfix">
    		...
    		<li class="green <?php echo $class; ?>" title="<?php echo __l('Served');?>"><?php echo $this->Html->link( $this->Html->cInt($served ,false) . '<span>' . __l('Served').'</span>', array('controller' => 'cities', 'action' => 'index', 'filter_id' => ConstMoreAction::Active), array('escape' => false));?></li>
    		...
    		<li class="suspended <?php echo $class; ?>" title="<?php echo __l('Unserved'); ?>"><?php echo $this->Html->link( $this->Html->cInt($unserved ,false) . '<span>' . __l('Unserved').'</span>', array('controller' => 'cities', 'action' => 'index', 'filter_id' => ConstMoreAction::Inactive), array('escape' => false));?></li>

            <?php $class = (empty($this->request->data['Property']['filter_id'])) ? ' active-filter' : null; ?>
    		<li class="black <?php echo $class; ?> " title="<?php echo __l('Total Records');?>"><?php echo $this->Html->link( $this->Html->cInt($served + $unserved ,false) . '<span>' . __l('Total Records').'</span>', array('controller' => 'cities', 'action' => 'index'), array('escape' => false)); ?></li>
        </ul>
		</div>
        ...
        <div class="grid_left">
         ...
         <div class="grid_left">
			...
			<div class=" info-details">
				<p><?php echo __l('Manage the served cities/cities that the website is targetting. Served cities will appear in the top of page for users to filter.'); ?></p>
				<p><?php echo __l('Here you can'); ?></p> 
                <p><?php echo __l('* Change a city\'s page background'); ?></p> 
                <p><?php echo __l('* Configure different default language for a city'); ?></p> 
                <p><?php echo __l('* Configure different Facebook, Twitter, Foursquare accounts for the items to get posted for the city'); ?></p> 
			</div>
    <?php endif; ?>  
     <div class=" ">   
		<?php
        ...
        <table class="list">
            <tr>
                ...
                <th><div class="js-pagination"><?php echo $this->Paginator->sort(__l('Active Items'), 'City.active_item_count');?></div></th>          
            </tr>
            <?php
            if (!empty($cities)):
                $i = 0;
                ...
                ?>
                    ...
                    <td class="select">
                     ...
                     <div class="action-block">
                        ...
                        <td class="dr"><?php echo $this->Html->cInt($city['City']['active_item_count']);?></td>
                     </tr>
                <?php
                endforeach;
                else:
