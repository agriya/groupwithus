...
<div class="clearfix grid_right add-block1">
	<?php echo $this->Html->link(__l('Add'),array('controller'=>'countries','action'=>'add'),array('class' => 'add admin-add', 'title' => __l('Add New Country')));?>
</div>
</div>
        <div> 
            ...
            <div class="overflow-block">
                ...
                <tr>
                    ...
                    <th rowspan="2" class="dr"><div class="js-pagination"><?php echo $this->Paginator->sort(__l('Fips104'), 'Country.fips104');?></div></th>
                    <th rowspan="2" class="dr"><div class="js-pagination"><?php echo $this->Paginator->sort(__l('Iso2'), 'Country.iso2');?></div></th>
                    <th rowspan="2" class="dr"><div class="js-pagination"><?php echo $this->Paginator->sort(__l('Iso3'), 'Country.iso3');?></div></th>
                    <th rowspan="2" class="dr"><div class="js-pagination"><?php echo $this->Paginator->sort(__l('Ison'), 'Country.ison');?></div></th>
                    <th rowspan="2" class="dr"><div class="js-pagination"><?php echo $this->Paginator->sort(__l('Internet'), 'Country.internet');?></div></th>
                ...
                if (!empty($countries)):
                    ...
                    foreach ($countries as $country):
                        ...
                        <span class="action-information-block">
                            ...
                            <td class="dr"><?php echo $this->Html->cText($country['Country']['fips104']);?></td>
                            <td class="dr"><?php echo $this->Html->cText($country['Country']['iso2']);?></td>
                            <td class="dr"><?php echo $this->Html->cText($country['Country']['iso3']);?></td>
                            <td class="dr"><?php echo $this->Html->cText($country['Country']['ison']);?></td>
                            <td class="dr"><?php echo $this->Html->cText($country['Country']['internet']);?></td>
