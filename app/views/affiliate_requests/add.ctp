...
<div class="affiliateRequests form">
	<h2 class="ribbon-title clearfix"><span class="ribbon-left"><span class="ribbon-right"><span class="ribbon-inner"><?php echo __l('Request Affiliate'); ?></span></span></span></h2>
<?php 
	if($status == 'pending'):
?>
