<div class="items-list-block">
    <ol class="items-list clearfix">
        ...
        <li class="<?php echo $class;?>">
            ...
            <?php } ?>
			<?php echo $this->Html->link($this->Html->showImage('Item', $attachment, array('dimension' => 'medium_thumb', 'alt' => sprintf(__l('[Image: %s]'), $this->Html->cText($item['Item']['name'], false)), 'title' => $this->Html->cText($item['Item']['name'], false))),array('controller' => 'items', 'action' => 'view', $item['Item']['slug']),array('title'=>$item['Item']['name'],'escape' =>false));?>
			    <?php echo $this->Html->cdateday($item['Item']['event_date']);?>
                <?php echo $this->Html->link($this->Html->cText($item['Item']['name'],false), array('controller' => 'items', 'action' => 'view', $item['Item']['slug']),array('title' =>sprintf(__l('%s'),$this->Html->cText($item['Item']['name'],false))));?>
            </div>
