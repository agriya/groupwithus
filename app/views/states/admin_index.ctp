<?php /* SVN: $Id: admin_index.ctp 71409 2011-11-15 10:04:09Z arovindhan_144at11 $ */ ?>
	<?php 
        ...
        <div class="states index js-response js-responses">
		  <div class="clearfix">
            <ul class="filter-list-block clearfix">
        		...
        		<li class="green <?php echo $class; ?>" title="<?php echo __l('Approved Records');?>"><?php echo $this->Html->link( $this->Html->cInt($approved ,false) . '<span>' . __l('Approved Records').'</span>', array('controller' => 'states', 'action' => 'index', 'filter_id' => ConstMoreAction::Active), array('escape' => false));?></li>
        		...
        		<li class="suspended <?php echo $class; ?>" title="<?php echo __l('Disapproved Records'); ?>"><?php echo $this->Html->link( $this->Html->cInt($pending ,false) . '<span>' . __l('Disapproved Records').'</span>', array('controller' => 'states', 'action' => 'index', 'filter_id' => ConstMoreAction::Inactive), array('escape' => false));?></li>

                <?php $class = (empty($this->request->data['Property']['filter_id'])) ? ' active-filter' : null; ?>
        		<li class="black <?php echo $class; ?> " title="<?php echo __l('Total Records');?>"><?php echo $this->Html->link( $this->Html->cInt($pending + $approved ,false) . '<span>' . __l('Total Records').'</span>', array('controller' => 'states', 'action' => 'index'), array('escape' => false)); ?></li>
            </ul>
		  </div>
