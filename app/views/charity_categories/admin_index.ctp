...
<div class="clearfix grid_right add-block1">
	<?php echo $this->Html->link(__l('Add'), array('controller'=>'charity_categories','action'=>'add'),array('title' => __l('Add'), 'class' =>'add admin-add'));?>
</div>
</div>
...
<table class="list">
    <tr>        
		...
		<th class="dl"><div class="js-pagination"><?php echo $this->Paginator->sort(__l('Category'), 'name');?></div></th>
		<th class="dr"><div class="js-pagination"><?php echo $this->Paginator->sort(__l('Charities'), 'charity_count');?></div></th>
    </tr>
<?php
                        ...
                        <span class="action-information-block">
                            ...
                            <div class="action-inner-left-block">
                                <ul class="action-link clearfix">
                                    <li><?php echo $this->Html->link(__l('Edit'), array('action' => 'edit', $charityCategory['CharityCategory']['id']), array('class' => 'edit js-edit', 'title' => __l('Edit')));?></li>
									<li><?php echo $this->Html->link(__l('Delete'), array('action' => 'delete', $charityCategory['CharityCategory']['id']), array('class' => 'delete js-delete', 'title' => __l('Delete')));?></li>
                                  </ul>
      							</div>
