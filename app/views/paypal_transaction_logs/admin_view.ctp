...
?>
	<dl class="list admin-list clearfix"><?php $i = 0; $class = ' class="altrow"';?>
		...
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php echo __l('Transaction');?></dt>
			<dd<?php if ($i++ % 2 == 0) echo $class;?>><?php echo !empty($paypalTransactionLog['Transaction']['id']) ? $this->Html->cInt($paypalTransactionLog['Transaction']['id']) : '-';?></dd>
		...
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php echo __l('Currency');?></dt>
			<dd<?php if ($i++ % 2 == 0) echo $class;?>><?php echo !empty($paypalTransactionLog['Currency']['code']) ? $this->Html->cText($paypalTransactionLog['Currency']['code']) : '-';?></dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php echo __l('Converted Currency');?></dt>
			<dd<?php if ($i++ % 2 == 0) echo $class;?>><?php echo !empty($paypalTransactionLog['ConvertedCurrency']['code']) ? $this->Html->cText($paypalTransactionLog['ConvertedCurrency']['code']) : '-';?></dd>
