...
<?php echo $this->element('user_affiliate_stat', array('cache' => array('config' => 'sec'))); ?>
...
<table class="list">
    <tr>
        ...
        <th><?php echo __l('User').'/'. __l('Item');?></th>
...
?>
	<tr<?php echo $class;?>>
        ...
        <td> 
			...
			?>	
					<?php echo $this->Html->cText($affiliate['ItemUser']['Item']['name'],false);?>
					(<?php echo $this->Html->link($this->Html->cText($affiliate['ItemUser']['User']['username']), array('controller'=> 'users', 'action' => 'view', $affiliate['ItemUser']['User']['username'], 'admin' => false), array('escape' => false));?>)
		<?php   } ?>
		</td>
...
<?php else: ?>
	<?php echo $this->element('pages-terms_and_policies', array('cache' => array('config' => 'sec', 'key' => 'affilates')));?>
	<?php 	
