		...
		<li class="grid_12 omega alpha">
			<div class="setting-details-info setting-category-<?php echo str_replace(',','',$setting_category['SettingCategory']['name']); ?>">
				...
				<div class="js-truncate">
					<?php echo str_replace('##PAYMENT_SETTINGS_URL##', Router::url('/', true) . $this->request->params['named']['city'] . '/admin/payment_gateways/index', $setting_category['SettingCategory']['description']); ?>
				</div>
			</div>
		</li>
	<?php endforeach; ?>
