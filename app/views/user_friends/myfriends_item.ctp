...
<?php echo $this->Form->create('UserFriend',array('class' => 'normal','action' => 'item_invite')); ?>
<ol class="item-firends-list friends clearfix " start="<?php echo $this->Paginator->counter(array('format' => '%start%')); ?>">
...
<?php
	...
	<?php echo $this->Form->input('item_slug',array('type' => 'hidden', 'label' => false));?>
</ol>
    <div class="clearfix">
     <?php
	echo $this->Form->submit(__l('Invite to item')); ?>
	</div>
	<?php
	echo $this->Form->end(); 
 }
