...
<h2 class="ribbon-title clearfix"><span class="ribbon-left"><span class="ribbon-right"><span class="ribbon-inner"><?php echo __l('Friends Import'); ?></span></span></span></h2>
<div class="form-blocks js-corner round-5">
<?php
	if(isset($exist_friend_arr) or isset($add_friend_arr) or isset($invite_friend_arr)) {
?>
<?php $item_invite_check = !empty($this->request->data['UserFriend']['item_slug']) ? $this->request->data['UserFriend']['item_slug'] : '';?>
<div id="friends-add-import-div">
	<div class="js-tabs">
		<ul class="clearfix">
			<li><?php echo $this->Html->link(sprintf(__l('Invite your contacts to %s'), Configure::read('site.name')), '#js-invite-list'); ?></li>
			<?php if(empty($item_invite_check)):?>
				<li><?php echo $this->Html->link(__l('Contacts found in your friends list'), '#js-friends-list'); ?></li>
				<li><?php echo $this->Html->link(sprintf(__l('Contacts found in %s'), Configure::read('site.name')), '#js-conatcts-list'); ?></li>
			<?php endif;?>
		</ul>
		<?php if(empty($item_invite_check)):?>
...
<div>
	<div class="page-info">
		...
		<p>
			...
			<span><?php echo $this->Html->link(__l('Privacy Policy'), array('controller' => 'page', 'action' => 'privacy_policy'), array('target' => '_blank', 'class'=>'js-contact-thickbox login-link'));?></span>
		</p>
	</div>
	<div class="js-tabs">
    	<ul class="clearfix">
	...
	<div id="csv-import">
		<div class="display-information">
			...
			<?php echo $this->Form->create('UserFriend', array('action' => 'import', 'class' => 'normal', 'id'=>'csv-form', 'enctype' => 'multipart/form-data'));?>
				<?php echo $this->Form->input('Attachment.filename', array('type' => 'file', 'div' => 'input file required',  'label' =>__l('Upload Friends'),'class' =>'browse-field','accept'=>"text/csv,text/plain")); ?>
             <div class="submit-block clearfix">
                <?php
                	echo $this->Form->submit(__l('Go'));
                ?>
