...
<table class="list">
    <tr>
        ...
        <th rowspan="3" class="dl"><?php echo $this->Paginator->sort(__l('display_name'));?></th>
	...
	<tr>       
		...
		<th><?php echo __l('Item Purchase');?></th>
    </tr>
...
?>
	<tr class="<?php echo $class.$active_class;?> <?php echo ($paymentGateway['PaymentGateway']['is_active'] ==1)? 'active-gateway-row': 'deactive-gateway-row'; ?>">
		<td class="actions">
