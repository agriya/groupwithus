			...
			<div class="message-block-right">
              ...
              <div class="mail-body js-corner round-5">
                    ...
                    if (!empty($all_parents)) :
                        ...
                        <span class="sender-info"> <?php echo $this->Html->cDateTimeHighlight($parent_message['Message']['created']);?> (<?php echo $time->timeAgoInWords($parent_message['Message']['created']); ?>)</span></p>
                        </div>
                        </div>
                     <div class="mail-reply-button">
    					<?php
                            echo $this->Html->link($this->Html->image('reply-button.png') , array('controller' => 'messages', 'action' => 'compose',$parent_message['Message']['id'],'reply') , null, null, false); ?>
                        </div>
                        <div class="js-show-mail-detail-div" style="display:none;">
                            ...
                            <?php
                                ...
                                echo $parent_message['User']['username']; ?> 
                            </p>
                            <p><span class="show-details-left">
                            <?php
                ...
                <div class="mail-date-time">
                    <p class="<?php echo $message['Message']['id'] ?>"><span class="js-show-mail-detail-span"><?php echo __l('show details'); ?></span><?php echo $this->Html->cDateTimeHighlight($message['Message']['created']); ?> (<?php echo $time->timeAgoInWords($message['Message']['created']); ?>)</span></p>
                </div>
                </div>
                <div class="mail-reply-button"><?php
                    echo $this->Html->link($this->Html->image('reply-button.png') , array('controller' => 'messages', 'action' => 'compose', $message['Message']['id'],'reply') , null, null, false); ?>
                </div>
