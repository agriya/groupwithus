...
<div class="paypalDocaptureLogs view">
	<dl class="list admin-list clearfix"><?php $i = 0; $class = ' class="altrow"';?>
		...
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php echo __l('Dodirectpayment Amt');?></dt>
			<dd<?php if ($i++ % 2 == 0) echo $class;?>><?php echo !empty($paypalDocaptureLog['PaypalDocaptureLog']['dodirectpayment_amt'])? $this->Html->siteCurrencyFormat($paypalDocaptureLog['PaypalDocaptureLog']['dodirectpayment_amt']):'-';?></dd>
