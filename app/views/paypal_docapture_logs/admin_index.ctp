...
<table class="list">
    <tr>
        ...
        <th rowspan = "2" class="dr"><?php echo $this->Paginator->sort(__l('Amount'),'mc_gross');?></th>
        <th rowspan = "2" class="dr"><?php echo $this->Paginator->sort('dodirectpayment_amt');?></th>
	...
	<tr>
        ...
        <th class="dr"><?php echo $this->Paginator->sort('Authorization ID', 'authorizationid');?></th>
		
        <th><?php echo $this->Paginator->sort('Timestamp', 'docapture_timestamp');?></th> 
        <th><?php echo $this->Paginator->sort('Ack', 'docapture_ack');?></th>        
		
        <th class="dr"><?php echo $this->Paginator->sort('Timestamp', 'dovoid_timestamp');?></th>
        <th class="dr"><?php echo $this->Paginator->sort('Ack', 'dovoid_ack');?></th>
	</tr>
<?php
...
?>
	<tr<?php echo $class;?>>
			...
			<span class="action-information-block">
				...
				<div class="action-inner-left-block">
					<ul class="action-link clearfix">
						<li><span><?php echo $this->Html->link(__l('View'), array('controller' => 'paypal_docapture_logs', 'action' => 'view', $paypalDocaptureLog['PaypalDocaptureLog']['id']), array('class' => 'view', 'title' => __l('View')));?></span></li>
					</ul>
				   </div>
		...
		<td><?php echo $this->Html->cDateTime($paypalDocaptureLog['PaypalDocaptureLog']['created']);?></td>
		<td><?php echo $this->Html->cText($paypalDocaptureLog['PaypalDocaptureLog']['authorizationid']);?></td>
		<td class="dr"><?php echo $this->Html->cText($paypalDocaptureLog['PaypalDocaptureLog']['dodirectpayment_amt']);?></td>
		<td class="dr"><?php echo $this->Html->cText($paypalDocaptureLog['PaypalDocaptureLog']['currencycode']);?></td>
		...
		<td class="dr"><?php echo $this->Html->cInt($paypalDocaptureLog['PaypalDocaptureLog']['authorizationid']);?></td>
		...
		<td class="dr"><?php echo (!empty($paypalDocaptureLog['PaypalDocaptureLog']['dovoid_timestamp']) ? $this->Html->cDateTime($paypalDocaptureLog['PaypalDocaptureLog']['dovoid_timestamp']) : '-');?></td>
		<td class="dr"><?php echo (!empty($paypalDocaptureLog['PaypalDocaptureLog']['dovoid_ack']) ? $this->Html->cText($paypalDocaptureLog['PaypalDocaptureLog']['dovoid_ack']) : '-');?></td>
	</tr>
<?php
    endforeach;
else:
