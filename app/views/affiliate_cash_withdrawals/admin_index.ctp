...
<div class="affiliateCashWithdrawals index js-response js-admin-index-autosubmit-over-block">
	...
	<div class="clearfix">
			...
			<li class="waitingforapproval <?php echo $class; ?>"  title="<?php echo __l('Pending'); ?>"><?php echo $this->Html->link( $this->Html->cInt($pending, false) . '<span>' . __l('Pending') . '</span>', array('controller' => 'affiliate_cash_withdrawals', 'action' => 'index', 'filter_id' => ConstAffiliateCashWithdrawalStatus::Pending), array('escape' => false));?>
           </li>
			...
			<li class="green <?php echo $class; ?>" title="<?php echo __l('Success');?>"><?php echo $this->Html->link( $this->Html->cInt($success ,false) . '<span>' . __l('Success').'</span>', array('controller' => 'user_cash_withdrawals', 'action' => 'index', 'filter_id' => ConstWithdrawalStatus::Success), array('escape' => false));?></li>
			...
			<li class="suspended <?php echo $class; ?>" title="<?php echo __l('Failed'); ?>"><?php echo $this->Html->link( $this->Html->cInt($failed ,false) . '<span>' . __l('Failed').'</span>', array('controller' => 'affiliate_cash_withdrawals', 'action' => 'index', 'filter_id' => ConstAffiliateCashWithdrawalStatus::Failed), array('escape' => false));?></li>

            <li class="verified <?php echo $class; ?>" title="<?php echo __l('Under Process'); ?>"><?php echo $this->Html->link( $this->Html->cInt($approved ,false) . '<span>' . __l('Under Process').'</span>', array('controller' => 'affiliate_cash_withdrawals', 'action' => 'index', 'filter_id' => ConstAffiliateCashWithdrawalStatus::Approved), array('escape' => false));?></li>
			...
			<li class="gray <?php echo $class; ?>" title="<?php echo __l('Rejected'); ?>"><?php echo $this->Html->link( $this->Html->cInt($rejected ,false) . '<span>' . __l('Rejected') . '</span>' , array('controller' => 'affiliate_cash_withdrawals', 'action' => 'index', 'filter_id' => ConstAffiliateCashWithdrawalStatus::Success), array('escape' => false));?></li>


            <?php $class = (empty($this->request->data['Property']['filter_id'])) ? ' active-filter' : null; ?>
			<li class="black <?php echo $class; ?> " title="<?php echo __l('All');?>"><?php echo $this->Html->link( $this->Html->cInt($approved + $pending + $rejected + $success + $failed ,false) . '<span>' . __l('All').'</span>', array('controller' => 'affiliate_cash_withdrawals', 'action' => 'index', 'filter_id' => 'all'), array('escape' => false)); ?></li>
            </ul>
