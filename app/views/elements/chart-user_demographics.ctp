<?php
	...
	if($this->Auth->user('user_type_id') == ConstUserTypes::Merchant){
		...
		$class_edu = "merchant-dashboard-edu-chart";
	}
?>
<?php if(!empty($chart_pie_education_data)): ?>
	<div class="js-load-pie-chart chart-half-section {'data_container':'user_pie_education_data<?php echo $user_type_id; ?>', 'chart_container':'user_pie_education_chart<?php echo $user_type_id; ?>', 'chart_title':'<?php echo __l('Education');?>', 'chart_y_title': '<?php echo $chart_y_title;?>'}">
...
<?php if(!empty($chart_pie_relationship_data)): ?>
	<div class="js-load-pie-chart chart-half-section {'data_container':'user_pie_relationship_data<?php echo $user_type_id; ?>', 'chart_container':'user_pie_relationship_chart<?php echo $user_type_id; ?>', 'chart_title':'<?php echo __l('Relationship');?>', 'chart_y_title': '<?php echo $chart_y_title;?>'}">
		<div class="dashboard-tl">
			<div class="dashboard-tr">
				<div class="dashboard-tc"></div>
			</div>
...
<?php if(!empty($chart_pie_employment_data)): ?>
	<div class="js-load-pie-chart chart-half-section {'data_container':'user_pie_employment_data<?php echo $user_type_id; ?>', 'chart_container':'user_pie_employment_chart<?php echo $user_type_id; ?>', 'chart_title':'<?php echo __l('Employment');?>', 'chart_y_title': '<?php echo $chart_y_title;?>'}">
		<div class="dashboard-tl">
			<div class="dashboard-tr">
				<div class="dashboard-tc"></div>
			</div>
...
<?php if(!empty($chart_pie_income_data)): ?>
	<div class="js-load-pie-chart chart-half-section {'data_container':'user_pie_income_data<?php echo $user_type_id; ?>', 'chart_container':'user_pie_income_chart<?php echo $user_type_id; ?>', 'chart_title':'<?php echo __l('Income');?>', 'chart_y_title': '<?php echo $chart_y_title;?>'}">
		<div class="dashboard-tl">
			<div class="dashboard-tr">
				<div class="dashboard-tc"></div>
			</div>
