...
<div class="curve-middle">
	<div class="curve-inner">
		<div id="div-navigate">
	        <div class="side-one openid-block1 pages">
				<h2 class="green-head"><?php echo __l('OpenID'); ?></h2>
				<div class="static-content-block">
				<div class="users form form-block js-login-response ajax-login-block">
					...
					<?php
						if(!(!empty($this->request->params['prefix']) && $this->request->params['prefix'] == 'admin')): 
    			            echo $this->Form->input('openid', array(
    			                ...
    			                'class' => 'bg-openid-input', 'label' => __l('Choose Your Id'),
