...
<?php echo $this->Form->create('User', array('action' => 'add_fund', 'class' => 'normal'));?>
	<fieldset>
	<?php
...
?>		
 	<p class="fund-available"><?php echo sprintf(__l('Available balance amount: %s'), $this->Html->siteCurrencyFormat($user['User']['available_balance_amount'])); ?></p>
	<?php
...
<?php echo $this->Form->end(__l('Add Fund'));?> </div>
</div>