...
<table class="list">
    ...
    <tr>
        <th class="dl"><?php echo $this->Paginator->sort(__l('City'), 'City.name');?></th>
        <th class="dl"><?php echo $this->Paginator->sort(__l('State'), 'State.name');?></th>
        <th class="dl"><?php echo $this->Paginator->sort(__l('Country'), 'Country.name');?></th>
