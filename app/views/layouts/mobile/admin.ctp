...
<body class="admin">
	<div id="<?php echo $this->Html->getUniquePageId();?>" class="content admin-content">
		<div id="header" class="clearfix">
			...
			<div class="clearfix">
			<h1 class="grid_4"><?php echo $this->Html->link(Configure::read('site.name'), Router::url('/',true).$city_slug, array('title' => Configure::read('site.name'))); ?></h1>
			 <?php
			...
			<ul class="menu">
				  <li><?php echo $this->Html->link(__l('Home'), array('controller' => 'items', 'action' => 'index','admin' => false), array('escape' => false, 'title' => __l('Home')));?></li>
