	...
	<div id="<?php echo $this->Html->getUniquePageId();?>" class="content">
			...
			<div id="sub-header">
                ...
                <div class="menu-block clearfix">
                    <ul class="menu clearfix">
                        ...
                        <li <?php if($this->request->params['controller'] == 'items' && (isset($this->request->params['named']['type']) && $this->request->params['named']['type'] == 'recent')) { echo 'class="active"'; } else { echo 'class=""';}?>><?php echo $this->Html->link(__l('Recent Items'), array('controller' => 'items', 'action' => 'index', 'admin' => false,'type' => 'recent'), array('title' => __l('Recent Items')));?></li>
                            <li <?php if($this->request->params['controller'] == 'users' && $this->request->params['action'] == 'register' && !empty($type)) { echo 'class="active"'; } else { echo 'class=""';}?>><?php echo $this->Html->link(__l('Merchant'), array('controller' => 'pages', 'action' => 'view', 'merchant', 'admin' => false), array('title' => __l('Merchant')));?></li>
		...
		<div id="footer">
			<div class="footer-wrapper-inner">
				...
				<h6 class="logo"><?php echo $this->Html->link(Configure::read('site.name'), array('controller' => 'items', 'action' => 'index'), array('title' => Configure::read('site.name')))?></h6>
