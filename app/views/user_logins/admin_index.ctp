<?php /* SVN: $Id: admin_index.ctp 71447 2011-11-15 11:37:49Z anandam_023ac09 $ */ ?>
	<?php 
...
<div class="page-count-block clearfix">
    ...
    <table class="list">
        <tr>
            ...
            <th class="dl"><div class="js-pagination"><?php echo $this->Paginator->sort(__l('Login IP'), 'Ip.ip');?></div></th>
