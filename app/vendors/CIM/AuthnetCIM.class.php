...
class AuthnetCIM
{
    ...
    {
		$this->params['billToCompany'] = !empty($this->params['billToCompany']) ? $this->params['billToCompany'] : '';
		$this->params['billToPhoneNumber'] = !empty($this->params['billToPhoneNumber']) ? $this->params['billToPhoneNumber'] : '';
		$this->params['billToFaxNumber'] = !empty($this->params['billToFaxNumber']) ? $this->params['billToFaxNumber'] : '';
        $this->xml = '<?xml version="1.0" encoding="utf-8"?>
