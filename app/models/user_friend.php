...
class UserFriend extends AppModel
{
    ...
    function getYahooContacts()
    {
        ...
        // then authorize app
        //echo Configure::read('invite.yahoo_consumer_key');
    ...
    function inviteItemUsers($invited_users = null, $item_slug = null)
    {
        //Item invite
        ...
        if (!empty($invited_users)) {
            foreach($invited_users as $invited_user) {
                ...
                $email = $this->EmailTemplate->selectTemplate('Item invite');
                $email_find = array(
