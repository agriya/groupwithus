...
class AffiliateRequestsController extends AppController
{
    ...
    public function admin_edit($id = null)
    {
        ...
        if (!empty($this->request->data)) {
            if ($this->AffiliateRequest->save($this->request->data)) {
            if($this->request->data['AffiliateRequest']['is_approved']){
            $this->__updateAffiliateUser(array($this->request->data['AffiliateRequest']['id']), 1);
            }else{
            $this->__updateAffiliateUser(array($this->request->data['AffiliateRequest']['id']), 0);
            }
        ...
        if (!empty($this->request->data[$this->modelClass])) {
            ...
            if ($actionid && !empty($ids)) {
                ...
                case ConstMoreAction::Disapproved:
                    ...
                    $this->Session->setFlash(__l('Disapproved the checked requests') , 'default', null, 'success');
                    break;
                ...
                case ConstMoreAction::Approved:
                    ...
                    $this->Session->setFlash(__l('Approved checked requests') , 'default', null, 'success');
                    break;
                ...
                case ConstMoreAction::Delete:
                    ...
                    $this->Session->setFlash(__l('Deleted the checked requests') , 'default', null, 'success');
                    break;
                }
            }
        }
