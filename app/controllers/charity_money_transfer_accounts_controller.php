...
class CharityMoneyTransferAccountsController extends AppController
{
	...
	public function beforeFilter()
    {
        $this->Security->disabledFields = array(
            'CharityMoneyTransferAccount.delete'
        );
        parent::beforeFilter();
    }
    ...
    {		
		...
		if (!empty($this->request->data)) {					
			if ($this->CharityMoneyTransferAccount->save($this->request->data)) {
			   ...
			   $ajax_url = Router::url(array('controller' => 'charity_money_transfer_accounts',
				'action' => 'index', $this->request->data['CharityMoneyTransferAccount']['charity_id']));
