...
class CharityCashWithdrawalsController extends AppController
{
    ...
    public function admin_index()
    {
		...
		$condition['CharityCashWithdrawalStatus.id'] = array(ConstCharityCashWithdrawalStatus::Approved, ConstCharityCashWithdrawalStatus::Failed, ConstCharityCashWithdrawalStatus::Success);
